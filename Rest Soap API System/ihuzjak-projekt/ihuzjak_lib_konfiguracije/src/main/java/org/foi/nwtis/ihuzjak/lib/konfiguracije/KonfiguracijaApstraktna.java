package org.foi.nwtis.ihuzjak.lib.konfiguracije;
...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
	...
	public static Konfiguracija dajKonfiguraciju(String nazivDatoteke) throws NeispravnaKonfiguracija {
		...
		default -> throw new NeispravnaKonfiguracija("ERROR 19 >> Datoteka: '" + nazivDatoteke
				 + "' nema podržani tip datoteke.");
		};
	}
	 ...
	 * Obrisi sve postavke.
	 *
	 * @return true, ako postavke nisu prazne, inaće false
	 */
	@Override
	 ...
	 *
	 * @param kljuc postavke
	 * @param vrijednost postavke
	 * @return true, ako ne postoji postavka s ključem, inaće false
	 */
	@Override
	 ...
	 * @param kljuc postavke
	 * @param vrijednost postavke
	 * @return true, ako postoji postavka s ključem, inaće false
	 */
	@Override
	 ...
	 *
	 * @param kljuc postavke
	 * @return true, ako postoji s ključem, inaće false
	 */
	@Override
	 ...
	 *
	 * @param kljuc postavke
	 * @return true, ako postoji postavka s ključem true, inaće false
	 */
	@Override
